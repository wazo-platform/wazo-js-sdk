(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("cross-fetch/polyfill"), require("immutable"), require("js-base64"), require("reconnecting-websocket"), require("sip.js"));
	else if(typeof define === 'function' && define.amd)
		define(["cross-fetch/polyfill", "immutable", "js-base64", "reconnecting-websocket", "sip.js"], factory);
	else if(typeof exports === 'object')
		exports["@wazo/sdk"] = factory(require("cross-fetch/polyfill"), require("immutable"), require("js-base64"), require("reconnecting-websocket"), require("sip.js"));
	else
		root["@wazo/sdk"] = factory(root["cross-fetch/polyfill"], root["immutable"], root["js-base64"], root["reconnecting-websocket"], root["sip.js"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_cross_fetch_polyfill__, __WEBPACK_EXTERNAL_MODULE_immutable__, __WEBPACK_EXTERNAL_MODULE_js_base64__, __WEBPACK_EXTERNAL_MODULE_reconnecting_websocket__, __WEBPACK_EXTERNAL_MODULE_sip_js__) {
...
/* harmony default export */ __webpack_exports__["default"] = (function (client, baseUrl) {
  return {
    ...
    removeCallNodes: function removeCallNodes(token, applicationUuid, nodeUuid, callId) {
      return client.delete("".concat(baseUrl, "/").concat(applicationUuid, "/nodes/").concat(nodeUuid, "/calls/").concat(callId), 'delete', null, token);
    }
  };
});
...
/* harmony default export */ __webpack_exports__["default"] = (function (client, baseUrl) {
  return {
    ...
    authenticate: function authenticate(token) {
      return client.get("".concat(baseUrl, "/token/").concat(token), null, {}).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
    ...
    logIn: function logIn() {
      ...
      return client.post("".concat(baseUrl, "/token"), body, headers).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
        return _domain_Session__WEBPACK_IMPORTED_MODULE_1__["default"].parse(response);
      }));
    },
    ...
    listUsers: function listUsers(token) {
      return client.get("".concat(baseUrl, "/users"), 'get', null, token);
    },
  ...
  return {
    search: function search(token, _search) {
      ...
      return client.get("".concat(baseUrl, "/users/me/cdr"), {
        search: _search,
        limit: limit
      }, token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = (function (client, baseUrl) {
  return {
    ...
    getUserLineSip: function getUserLineSip(token, userUuid, lineId) {
      return client.put("".concat(baseUrl, "/users/").concat(userUuid, "/lines/").concat(lineId, "/associated/endpoints/sip"), null, token);
    },
...
/* harmony import */ var _domain_BadResponse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../domain/BadResponse */ "./src/domain/BadResponse.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (client, baseUrl) {
  return {
    ...
    listMessages: function listMessages(token, participantUuid) {
      ...
      return client.get("".concat(baseUrl, "/users/me/chats"), body, token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
        return _domain_ChatMessage__WEBPACK_IMPORTED_MODULE_1__["default"].parseMany(response);
      }));
    },
    sendMessage: function sendMessage(token, alias, message, toUserId) {
      var body = {
        alias: alias,
        message: message,
        to: toUserId
    ...
    listCalls: function listCalls(token) {
      return client.get("".concat(baseUrl, "/users/me/calls"), null, token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
    ...
    listVoicemails: function listVoicemails(token) {
      return client.get("".concat(baseUrl, "/users/me/voicemails"), null, token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = (function (client, baseUrl) {
  return {
    ...
    listPersonalContacts: function listPersonalContacts(token) {
      return client.get("".concat(baseUrl, "/personal"), null, token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
        return _domain_Contact__WEBPACK_IMPORTED_MODULE_1__["default"].parseManyPersonal(response);
      }));
    },
    addContact: function addContact(token, contact) {
      return client.post("".concat(baseUrl, "/personal"), getContactPayload(contact), token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
    ...
    listFavorites: function listFavorites(token, context) {
      return client.get("".concat(baseUrl, "/directories/favorites/").concat(context), null, token).then(_utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].parseBadResponse(function (response) {
        return _domain_Contact__WEBPACK_IMPORTED_MODULE_1__["default"].parseMany(response);
      }));
    },
    markAsFavorite: function markAsFavorite(token, source, sourceId) {
      ...
      return client.put(url, 'put', null, token, _utils_api_requester__WEBPACK_IMPORTED_MODULE_0__["default"].successResponseParser);
    },
...
function () {
  _createClass(BadResponse, null, [{
    ...
    key: "fromText",
    value: function fromText(response) {
  ...
  function BadResponse(message) {
    ...
    var errorId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
var CallRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  id: undefined,
...
var Call =
/*#__PURE__*/
function (_CallRecord) {
  _inherits(Call, _CallRecord);

  function Call() {
    _classCallCheck(this, Call);

    return _possibleConstructorReturn(this, _getPrototypeOf(Call).apply(this, arguments));
  }
  ...
  _createClass(Call, [{
    ...
    value: function parse(plain) {
      return new Call({
        ...
        status: plain.status,
        startingTime: moment__WEBPACK_IMPORTED_MODULE_1___default()(plain.creation_time)
      });
    }
  }]);
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Session__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Session */ "./src/domain/Session.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var CallLogRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  answer: undefined,
  answered: undefined,
  newMissedCall: false,
...
var CallLog =
/*#__PURE__*/
function (_CallLogRecord) {
  _inherits(CallLog, _CallLogRecord);

  function CallLog() {
    _classCallCheck(this, CallLog);

    return _possibleConstructorReturn(this, _getPrototypeOf(CallLog).apply(this, arguments));
  }
  ...
  _createClass(CallLog, [{
    ...
    value: function parse(plain) {
      return new CallLog({
        answer: moment__WEBPACK_IMPORTED_MODULE_1___default()(plain.answer),
        ...
        start: moment__WEBPACK_IMPORTED_MODULE_1___default()(plain.start),
        end: moment__WEBPACK_IMPORTED_MODULE_1___default()(plain.end)
      });
    }
  }, {
    key: "parseNew",
...
var ChatMessageRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  id: undefined,
  date: undefined,
  message: undefined,
  direction: undefined,
...
var ChatMessage =
/*#__PURE__*/
function (_ChatMessageRecord) {
  _inherits(ChatMessage, _ChatMessageRecord);
  ...
  _createClass(ChatMessage, [{
    ...
    value: function parse(plain) {
      return new ChatMessage({
        id: uuid(),
        date: moment__WEBPACK_IMPORTED_MODULE_1___default()(plain.date),
        message: plain.msg,
...
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! immutable */ "immutable");
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(immutable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Session__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Session */ "./src/domain/Session.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ContactRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  name: undefined,
  number: undefined,
  favorited: undefined,
  email: undefined,
...
var Contact =
/*#__PURE__*/
function (_ContactRecord) {
  _inherits(Contact, _ContactRecord);
...
var ForwardOptionRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  destination: undefined,
  enabled: undefined,
  key: undefined
});
...
var ForwardOption =
/*#__PURE__*/
function (_ForwardOptionRecord) {
  _inherits(ForwardOption, _ForwardOptionRecord);

  function ForwardOption() {
    _classCallCheck(this, ForwardOption);

    return _possibleConstructorReturn(this, _getPrototypeOf(ForwardOption).apply(this, arguments));
  }
...
var LineRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  id: undefined,
  extensions: []
});
...
var Line =
/*#__PURE__*/
function (_LineRecord) {
  _inherits(Line, _LineRecord);
...
var NotificationOptionsRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  sound: true,
  vibration: true
});
...
/*#__PURE__*/
function (_NotificationOptionsR) {
  _inherits(NotificationOptions, _NotificationOptionsR);

  function NotificationOptions() {
    _classCallCheck(this, NotificationOptions);

    return _possibleConstructorReturn(this, _getPrototypeOf(NotificationOptions).apply(this, arguments));
  }
...
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! immutable */ "immutable");
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(immutable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Line__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Line */ "./src/domain/Line.js");
/* harmony import */ var _ForwardOption__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ForwardOption */ "./src/domain/ForwardOption.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ProfileRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  id: undefined,
  firstname: undefined,
  lastname: undefined,
  email: undefined,
...
var Profile =
/*#__PURE__*/
function (_ProfileRecord) {
  _inherits(Profile, _ProfileRecord);
    ...
    value: function parse(plain) {
      return new Profile({
        ...
        lines: plain.lines.map(function (line) {
          return _Line__WEBPACK_IMPORTED_MODULE_1__["default"].parse(line);
        }),
        username: plain.username,
        mobileNumber: plain.mobile_phone_number || '',
        forwards: [_ForwardOption__WEBPACK_IMPORTED_MODULE_2__["default"].parse(plain.forwards.unconditional, _ForwardOption__WEBPACK_IMPORTED_MODULE_2__["FORWARD_KEYS"].UNCONDITIONAL), _ForwardOption__WEBPACK_IMPORTED_MODULE_2__["default"].parse(plain.forwards.noanswer, _ForwardOption__WEBPACK_IMPORTED_MODULE_2__["FORWARD_KEYS"].NO_ANSWER), _ForwardOption__WEBPACK_IMPORTED_MODULE_2__["default"].parse(plain.forwards.busy, _ForwardOption__WEBPACK_IMPORTED_MODULE_2__["FORWARD_KEYS"].BUSY)],
...
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! immutable */ "immutable");
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(immutable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Profile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Profile */ "./src/domain/Profile.js");
/* harmony import */ var _Contact__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Contact */ "./src/domain/Contact.js");
/* harmony import */ var _Line__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Line */ "./src/domain/Line.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var SessionRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_0__["Record"])({
  token: undefined,
  uuid: undefined,
  profile: undefined
});
...
function (_SessionRecord) {
  _inherits(Session, _SessionRecord);
...
var VoicemailRecord = Object(immutable__WEBPACK_IMPORTED_MODULE_1__["Record"])({
  id: undefined,
  date: undefined,
  duration: undefined,
  caller: {
...
var Voicemail =
/*#__PURE__*/
function (_VoicemailRecord) {
  _inherits(Voicemail, _VoicemailRecord);

  function Voicemail() {
    _classCallCheck(this, Voicemail);

    return _possibleConstructorReturn(this, _getPrototypeOf(Voicemail).apply(this, arguments));
  }
  ...
  _createClass(Voicemail, [{
    ...
    value: function parse(plain) {
      return new Voicemail({
        id: plain.id,
        date: moment__WEBPACK_IMPORTED_MODULE_0___default.a.unix(plain.timestamp),
        duration: moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(plain.duration, 'seconds'),
        caller: {
    ...
    value: function parseMany(plain) {
      ...
      var unread = plainUnread.map(function (message) {
        ...
        return voicemail.set('unread', true);
      });
      var read = plainRead.map(function (message) {
        return Voicemail.parse(message);
      }).map(function (voicemail) {
        return voicemail.set('unread', false);
      });
...
/* harmony import */ var _domain_Call__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domain/Call */ "./src/domain/Call.js");
/* harmony import */ var _domain_CallLog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./domain/CallLog */ "./src/domain/CallLog.js");
/* harmony import */ var _domain_ChatMessage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./domain/ChatMessage */ "./src/domain/ChatMessage.js");
/* harmony import */ var _domain_Contact__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./domain/Contact */ "./src/domain/Contact.js");
/* harmony import */ var _domain_Country__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./domain/Country */ "./src/domain/Country.js");
/* harmony import */ var _domain_ForwardOption__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./domain/ForwardOption */ "./src/domain/ForwardOption.js");
/* harmony import */ var _domain_Line__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./domain/Line */ "./src/domain/Line.js");
/* harmony import */ var _domain_NotificationOptions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./domain/NotificationOptions */ "./src/domain/NotificationOptions.js");
/* harmony import */ var _domain_Profile__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./domain/Profile */ "./src/domain/Profile.js");
/* harmony import */ var _domain_Session__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./domain/Session */ "./src/domain/Session.js");
/* harmony import */ var _domain_Voicemail__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./domain/Voicemail */ "./src/domain/Voicemail.js");
/* harmony import */ var _domain_Phone_DebugPhone__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./domain/Phone/DebugPhone */ "./src/domain/Phone/DebugPhone.js");
/* harmony import */ var _domain_Device_DebugDevice__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./domain/Device/DebugDevice */ "./src/domain/Device/DebugDevice.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  Call: _domain_Call__WEBPACK_IMPORTED_MODULE_4__["default"],
  CallLog: _domain_CallLog__WEBPACK_IMPORTED_MODULE_5__["default"],
  ChatMessage: _domain_ChatMessage__WEBPACK_IMPORTED_MODULE_6__["default"],
  Contact: _domain_Contact__WEBPACK_IMPORTED_MODULE_7__["default"],
  Country: _domain_Country__WEBPACK_IMPORTED_MODULE_8__["default"],
  ForwardOption: _domain_ForwardOption__WEBPACK_IMPORTED_MODULE_9__["default"],
  Line: _domain_Line__WEBPACK_IMPORTED_MODULE_10__["default"],
  NotificationOptions: _domain_NotificationOptions__WEBPACK_IMPORTED_MODULE_11__["default"],
  Profile: _domain_Profile__WEBPACK_IMPORTED_MODULE_12__["default"],
  Session: _domain_Session__WEBPACK_IMPORTED_MODULE_13__["default"],
  Voicemail: _domain_Voicemail__WEBPACK_IMPORTED_MODULE_14__["default"],
  DebugPhone: _domain_Phone_DebugPhone__WEBPACK_IMPORTED_MODULE_15__["default"],
  DebugDevice: _domain_Device_DebugDevice__WEBPACK_IMPORTED_MODULE_16__["default"]
});
...
function () {
  _createClass(ApiRequester, null, [{
    ...
    key: "parseBadResponse",
    value: function parseBadResponse(parse) {
      return function (response) {
        return response instanceof _domain_BadResponse__WEBPACK_IMPORTED_MODULE_2__["default"] ? response : parse(response);
      };
    }
  }, {
    key: "defaultParser",
    value: function defaultParser(response, isJson) {
      if (!response.ok) {
        return (isJson ? response.json() : response.text()).then(function (error) {
          return isJson ? _domain_BadResponse__WEBPACK_IMPORTED_MODULE_2__["default"].fromResponse(error) : _domain_BadResponse__WEBPACK_IMPORTED_MODULE_2__["default"].fromText(error);
        });
      }
  ...
  _createClass(ApiRequester, [{
    ...
    value: function call(path) {
      ...
      var newParse = method === 'delete' || method === 'head' ? ApiRequester.successResponseParser : parse;
      var options = {
        method: method,
        body: newBody,
      ...
      return fetch(url, options).then(function (response) {
        ...
        _logger__WEBPACK_IMPORTED_MODULE_3__["default"].logRequest(url, options, response); // Throw an error only if status >= 500
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WebRTCClient; });
...
var getCallerID = function getCallerID(session) {
  return {
...
var getAutoAnswer = function getAutoAnswer(request) {
  return !!request.getHeader('alert-info');
};

var DESTINATION_REGEXP = /^\+?[0-9#*]+$/;
...
function () {
  ...
  _createClass(WebRTCClient, [{
    key: "configureUserAgent",
    value: function configureUserAgent() {
      var _this = this;

      var userAgent = new sip_js__WEBPACK_IMPORTED_MODULE_0___default.a.Web.Simple(this.getConfig());
      userAgent.on('registered', function () {
        _this.callback('phone-events-registered');
      });
      userAgent.on('unregistered', function () {
        _this.callback('phone-events-unregistered');
      });
      userAgent.on('new', function (session) {
        var info = {
          callerid: getCallerID(session),
          autoanswer: getAutoAnswer(session.request)
        };

        _this.callback('phone-events-new', info);
      });
      userAgent.on('ringing', function () {
        _this.callback('phone-events-ringing');
      });
      userAgent.on('connected', function () {
        _this.callback('phone-events-connected');
      });
      userAgent.on('ended', function () {
        _this.callback('phone-events-ended');
      });
      return userAgent;
    }
  }, {
...
function () {
  ...
  _createClass(WebSocketClient, [{
    ...
    value: function connect() {
      ...
      var sock = new reconnecting_websocket__WEBPACK_IMPORTED_MODULE_0___default.a("wss://".concat(this.host, "/api/websocketd/?token=").concat(this.token));
      sock.debug = false;
      ...
      sock.onmessage = function (event) {
        ...
        if (!_this.initialized) {
          _this.handleMessage(message, sock);
        } else {
...
module.exports = __WEBPACK_EXTERNAL_MODULE_cross_fetch_polyfill__;
