...
export const GLOBAL_VOICEMAIL_MESSAGE_CREATED = 'global_voicemail_message_created';
export const GLOBAL_VOICEMAIL_MESSAGE_UPDATED = 'global_voicemail_message_updated';
export const GLOBAL_VOICEMAIL_MESSAGE_DELETED = 'global_voicemail_message_deleted';
...
export const USER_VOICEMAIL_TRANSCRIPTION_CREATED = 'user_voicemail_transcription_created';
export const USER_VOICEMAIL_TRANSCRIPTION_DELETED = 'user_voicemail_transcription_deleted';
export const GLOBAL_VOICEMAIL_TRANSCRIPTION_CREATED = 'global_voicemail_transcription_created';
export const GLOBAL_VOICEMAIL_TRANSCRIPTION_DELETED = 'global_voicemail_transcription_deleted';
...
WebSocketClient.eventLists = [AUTH_SESSION_EXPIRE_SOON, FAVORITE_ADDED, FAVORITE_DELETED, USER_STATUS_UPDATE, CHAT_MESSAGE_SENT, CHAT_MESSAGE_RECEIVED, ENDPOINT_STATUS_UPDATE, USERS_FORWARDS_BUSY_UPDATED, USERS_FORWARDS_NOANSWER_UPDATED, USERS_FORWARDS_UNCONDITIONAL_UPDATED, USERS_SERVICES_DND_UPDATED, GLOBAL_VOICEMAIL_MESSAGE_CREATED, GLOBAL_VOICEMAIL_MESSAGE_UPDATED, GLOBAL_VOICEMAIL_MESSAGE_DELETED, USER_VOICEMAIL_MESSAGE_CREATED, USER_VOICEMAIL_MESSAGE_UPDATED, USER_VOICEMAIL_MESSAGE_DELETED, USER_VOICEMAIL_TRANSCRIPTION_CREATED, USER_VOICEMAIL_TRANSCRIPTION_DELETED, GLOBAL_VOICEMAIL_TRANSCRIPTION_CREATED, GLOBAL_VOICEMAIL_TRANSCRIPTION_DELETED, CALL_LOG_USER_CREATED, CALL_ANSWERED, CALL_CREATED, CALL_DTMF_CREATED, CALL_ENDED, CALL_UPDATED, CALL_HELD, CALL_RESUMED, AUTH_USER_EXTERNAL_AUTH_ADDED, AUTH_USER_EXTERNAL_AUTH_DELETED, CHATD_PRESENCE_UPDATED, CHATD_USER_ROOM_MESSAGE_CREATED, CHATD_USER_ROOM_CREATED, CONFERENCE_USER_PARTICIPANT_JOINED, CONFERENCE_USER_PARTICIPANT_LEFT, MEETING_USER_PARTICIPANT_JOINED, MEETING_USER_PARTICIPANT_LEFT, CONFERENCE_USER_PARTICIPANT_TALK_STARTED, CONFERENCE_USER_PARTICIPANT_TALK_STOPPED, SWITCHBOARD_QUEUED_CALLS_UPDATED, SWITCHBOARD_QUEUED_CALL_ANSWERED, SWITCHBOARD_HELD_CALLS_UPDATED, SWITCHBOARD_HELD_CALL_ANSWERED, FAX_OUTBOUND_USER_CREATED, FAX_OUTBOUND_USER_SUCCEEDED, FAX_OUTBOUND_USER_FAILED, APPLICATION_CALL_DTMF_RECEIVED, APPLICATION_CALL_ENTERED, APPLICATION_CALL_INITIATED, APPLICATION_CALL_DELETED, APPLICATION_CALL_UPDATED, APPLICATION_CALL_ANSWERED, APPLICATION_PROGRESS_STARTED, APPLICATION_PROGRESS_STOPPED, APPLICATION_DESTINATION_NODE_CREATED, APPLICATION_NODE_CREATED, APPLICATION_NODE_DELETED, APPLICATION_NODE_UPDATED, APPLICATION_PLAYBACK_CREATED, APPLICATION_PLAYBACK_DELETED, APPLICATION_SNOOP_CREATED, APPLICATION_SNOOP_DELETED, APPLICATION_SNOOP_UPDATED, APPLICATION_USER_OUTGOING_CALL_CREATED, TRUNK_STATUS_UPDATED, LINE_STATUS_UPDATED, AGENT_STATUS_UPDATE, AGENT_PAUSED, AGENT_UNPAUSED, AGENT_QUEUE_LOGGED_IN, AGENT_QUEUE_LOGGED_OUT, CONFERENCE_ADHOC_PARTICIPANT_LEFT, CONFERENCE_ADHOC_DELETED, MEETING_USER_PROGRESS, MEETING_USER_GUEST_AUTHORIZATION_CREATED];
