...
export default class WebRTCPhone extends Emitter implements Phone {
  ...
  sipSessions: { [string]: Inviter | Invitation };

  incomingSessions: string[];

  currentSipSession: Inviter | Invitation;
  ...
  _bindEvents(sipSession: Inviter) {
    ...
    sipSession.on(this.client.REJECTED, () => {
      this._onCallTerminated(sipSession);
    ...
    // @TODO
    sipSession.on('reinvite', (session: Invitation | Inviter, message: any) => {
  ...
  _onCallAccepted(sipSession: Inviter | Invitation, videoEnabled: boolean): CallSession {
  ...
  _onCallTerminated(sipSession: Inviter | Invitation) {
  ...
  atxfer(sipSession: Inviter | Invitation): ?Object {
    return this.client.atxfer(sipSession);
  }

  holdSipSession(sipSession: Inviter | Invitation, withEvent: boolean = true): void {
    if (!sipSession) {
      return;
    }
  ...
  unholdSipSession(sipSession: Inviter | Invitation, withEvent: boolean = true): void {
    if (!sipSession) {
      return;
    }
  ...
  sendMessage(sipSession: Inviter | Invitation = null, body: string, contentType: string = 'text/plain') {
    if (!sipSession) {
      return;
    }
  ...
  bindClientEvents() {
    ...
    this.client.on(this.client.INVITE, (sipSession: Inviter | Invitation, wantsToDoVideo: boolean) => {
  ...
  _createMutedCallSession(sipSession: Inviter | Invitation, fromSession?: CallSession): CallSession {
    return this._createCallSession(sipSession, fromSession, {
      muted: true,
  ...
  _createUnmutedCallSession(sipSession: Inviter | Invitation, fromSession?: CallSession): CallSession {
    return this._createCallSession(sipSession, fromSession, {
      cameraEnabled: this.client.sessionHasLocalVideo(this.client.getSipSessionId(sipSession)),
    });
  }

  _createCameraResumedCallSession(sipSession: Inviter | Invitation, fromSession?: CallSession): CallSession {
    return this._createCallSession(sipSession, fromSession, {
  ...
  _createCameraDisabledCallSession(sipSession: Inviter | Invitation, fromSession?: CallSession): CallSession {
    return this._createCallSession(sipSession, fromSession, {
      muted: !this.client.sessionHasAudio(sipSession),
      cameraEnabled: false,
    });
  ...
  _findSipSession(callSession: ?CallSession): ?Inviter | Invitation {
